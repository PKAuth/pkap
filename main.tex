...
This document defines PKAuth, a federated authentication protocol based on public key cryptography. 
PKAuth's primary goal is to improve the security and usability of authentication. 
...
PKAuth has many practical applications. 
It allows users to authenticate to websites using public key cryptography. 
Client-side applications on mobile and desktop can also authenticate their users with PKAuth. 
In addition, PKAuth can be used alongside the Internet of Things (IoT) to provide access to network resources for a group of users. 
...
PKAuth distributes keys using a recursive, self-signing public key infrastructure. 
